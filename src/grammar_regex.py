...
lparen, rparen, lbrace, rbrace, char = regex_grammar.terminal((ast.TOKEN_TYPE.ALT, r"|"),
                                                         (ast.TOKEN_TYPE.STAR, r"*"),
                                                         (ast.TOKEN_TYPE.PLUS, r"+"),
                                                         (ast.TOKEN_TYPE.MINUS, r"-"),
                                                         (ast.TOKEN_TYPE.ACC, r"^"),
                                                         (ast.TOKEN_TYPE.ASK, r"?"),
                                                         (ast.TOKEN_TYPE.ESC, "\\"),
                                                         (ast.TOKEN_TYPE.DOT, r"."),
                                                         (ast.TOKEN_TYPE.LPAREN, r"("),
                                                         (ast.TOKEN_TYPE.RPAREN, r")"),
                                                         (ast.TOKEN_TYPE.LBRACE, r"["),
                                                         (ast.TOKEN_TYPE.RBRACE, r"]"),
                                                         (ast.TOKEN_TYPE.CHAR, r""))
